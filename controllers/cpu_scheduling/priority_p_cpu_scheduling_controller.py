# controllers/cpu_scheduling/priority_p_cpu_scheduling_controller.py
from models.cpu_scheduling.priority_p_cpu_scheduling_model import Job, priority_p_schedule

class PriorityPCPUController:
    ...
    def generate_gantt(self):
        ...
        # Validate priority presence and integer
        for job in jobs:
        ...
        events = priority_p_schedule(jobs)
